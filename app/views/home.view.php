                        ...
                        <div class="row m-0 mb-4 mb-md-0 pb-2 pb-md-0">
                            <div class="col-md-6 p-0 text-center text-md-right">
                                <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-5">
                                    ...
                                    <p><?= esc($row->about) ?></p>
                                    <h3 class="font-secondary font-weight-normal text-muted mb-3"><i class="fa fa-<?= esc($row->icon) ?> text-primary pr-3"></i><?= esc($row->name) ?></h3>
                    ...
                    <?php foreach ($stories as $row) : $num++; ?>
                        <?php if ($num % 2) :  ?>
                            <div class="row">
                                <div class="col-md-6 text-center text-md-right">
                                    <img class="img-fluid mr-md-3" src="<?= get_image($row->image) ?>" style="max-width: 400px; max-height: 400px; object-fit: cover" alt="">
                                </div>
                        ...
                        <?php else : ?>
                            <div class="row">
                                ...
                                <div class="col-md-6 text-center text-md-left">
                                    <img class="img-fluid ml-md-3" src="<?= get_image($row->image) ?>" style="max-width: 400px; max-height: 400px; object-fit: cover" alt="">
                                </div>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                    ...
                    <?php foreach ($family as $row) : ?>
                        <div class="col-lg-4 col-md-6 mb-4 portfolio-item first">
                            <div class="position-relative mb-2">
                                <img class="img-fluid w-100" src="<?= get_image($row->image) ?>" alt="" style="object-fit: cover; height: 275px;">
                                <div class="bg-secondary text-center p-4">
                                    <h4 class="mb-3"><?= esc($row->name) ?></h4>
                                    <p class="text-uppercase"><?= esc($row->title) ?></p>
                                    <div class="d-inline-block">
                                        <a target="_blank" class="mx-2" href="<?= esc($row->twitter_link) ?>"><i class="fab fa-twitter"></i></a>
                                        <a target="_blank" class="mx-2" href="<?= esc($row->facebook_link) ?>"><i class="fab fa-facebook-f"></i></a>
                                        <a target="_blank" class="mx-2" href="<?= esc($row->linkedin_link) ?>"><i class="fab fa-linkedin-in"></i></a>
                                        <a target="_blank" class="mx-2" href="<?= esc($row->instagram_link) ?>"><i class="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
